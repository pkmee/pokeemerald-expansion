...
extern const u32 gItemIcon_BigAxe[]; // qol_field_moves start
extern const u32 gItemIconPalette_BigAxe[];
...
extern const u32 gItemIconPalette_ScubaGear[]; // qol_field_moves end
